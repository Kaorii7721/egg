...
module.exports = {
  ...
  networks: {
    megumii: {
     provider: () => new HDWalletProvider(mnemonic, `https://evm.dym.kessoku.xyz`),
     network_id: 6349524,       // Ropsten's id
     gas: 40000000,        // Ropsten has a lower block limit than mainnet
